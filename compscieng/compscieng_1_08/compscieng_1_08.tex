...
Son bir konuya daha değinmek isterim; matris çarpımına değişik bir bakış açısı
konusu. Bu önemli çünkü ADANI gibi sonlu öğeler paketleri çarpımı böyle
yapıyorlar.
...
Şimdi bu matrisin problemimiz bağlamında bir anlamı da var (bakış açısının iyi
bir faydası da bu), üstteki matris bir öğe matrisi. Üstteki parça içinde $c_1$
içeren parça. Belki soldan ikinci kolon $c_2$ ve sağdan ikinci satırı kullanınca
...
biraraya getirir. ADINA turu sistemler klasik çarpımı yapmazlar, tarif ettiğimiz
