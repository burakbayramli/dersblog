...
(1) formülüne bu arada Burger'in denklemi (Burger's equation) ismi veriliyor.
Fakat aslında tüm ismi ağdaşız (ınvişcid) Burger'in denklemi, çünkü denklem
sıfıra eşit. Bu formül ve tarihi hakkında birkaç kelime edelim, Burger eşitliğin
sağında bir $u_{xx}$ kullanmıştı ilk önce, tasinim $u u+x$ üzerinden hala gayrı
lineerdi. Bunlar Navier-Stokes denkleminde gördüğümüz türden şeyler değil mi?
NS'te de daha genel durumda tabii, ama orada da bir gayrı lineerlik
var. Burger'in formülünde bu daha basitleştirilmiş bir durumda tabii.
