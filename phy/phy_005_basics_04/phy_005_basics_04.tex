...
noktasında ve orijin bazlı herhangi bir yönde alalım, hareketler hep bu konuma
referansla, onu değiştirecek şekilde düşünülebilir.  Mesela gövde üzerindeki,
gövde uzayındaki, herhangi bir $p_0$ noktasını düşünelim, $t$ anında bu noktanın
dünya uzayındaki konumu
...
kütle merkezine uygulandığı için $a(t)$ aynı zamanda kütle merkezinin dünya
uzayında olduğu yeri de gösteriyor.
...
Bunu kullanarak ve 3 x 3 boyutlu birim matrisi $\vec{1}$ ile göstererek,
