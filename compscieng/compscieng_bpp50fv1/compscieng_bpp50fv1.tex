...
alıyoruz, dikkat bu entegral dışarıdan içeri doğru yani entegral (5)'in tüm iç
kısmı

$$
\int _{0}^{\infty}
\underbrace{\int _{-\infty}^{\infty} u_t \phi + f(u)_x \phi \ud x}_{\textrm{iç kısım}}
\ud t = 0
$$

üzerinde alınmış olacak. $y,\ud z$ tanımladık, o zaman $z=u$,
