...
cisim duruşu ve dönüş mekanığını kuaterniyon kavramı üzerinden hesaplayacağız,
...
cismin orijine olan uzaklığı $\vec{r}$ ile $m\vec{v}v$ çapraz çarpımıdır [1, sf. 42].
...
Hareket denklemlerinde $L$ hesabı yapmak için üstteki denklemi entegre etmek
gerekir, sonsuz küçük tork değerleri $L$ hesabı için kullanılır. 
