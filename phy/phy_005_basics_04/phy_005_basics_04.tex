...
Burada $x,y,z$ değerleri gövde uzayında, her nokta $r_i$ için $x,y,z$ değerleri
$r_i - a(t)$ öğeleriyle hesaplanıyor. Ayrıca bir obje dönerse, onun belli
noktalarının eksenden olan uzaklıkları değişir ve farklı bir $I$ elde
ederiz... fakat üstteki hesabı obje hareket ederken sürekli yapmak oldukca
külfetli. Acaba $I$'nin bir baz kısmını hesaplasak, sonra dönüşe göre onu
