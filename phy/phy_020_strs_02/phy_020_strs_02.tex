...
muhakkak (çünkü faraziyelerle pek çok şeyi burada basitleştirdik) ama üç tane
...
Referans nokta gerekli cunku hatirlarsak moment bir nokta etrafindaki
dondurmeye baglidir, kuvvet donus capina teget olan kuvvettir. O zaman 

$$
-M + \left( M + \frac{\ud M}{\ud X_1} \ud X_1 \right) - V \ud X_1 -
q \ud X_1 \left( \frac{\ud X_1}{2}  \right) = 0
$$
