...
performans kaybını yanlarında getirmiş oldular [3]. Rüst modern, açık
...
geçmek mümkündür, ve bu bazen istenmeyen hafıza erişim hatalarına,
hatta güvenlik açıklarına sebep olmakdadır. Rust bu tür kullanımlarına
hafıza erişimine performans kısıtlaması getirmeden, ya da erişimi
yasaklamadan bir kontrol mekanizması getirmiştir. 
