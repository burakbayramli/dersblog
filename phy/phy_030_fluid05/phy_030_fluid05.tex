...
ki burada $m$ gazın kütlesi, $w_m$ ise moleküler ağırlık. Bunları
birbirine bölünce doğal olarak mol sayısı ortaya çıkar. Ama $n$'yi iki
üstteki formüle koyunca,
...
yeni bir sabi $R_m$ diyebiliriz, o zaman

$$
P = \rho R_m T
$$

formülü de geçerlidir. 
