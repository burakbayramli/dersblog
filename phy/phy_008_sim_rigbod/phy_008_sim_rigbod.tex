...
grafileme açısından kolay olduğu için öyle çizildi fakat aslında hesaplara göre
vektörün üçü kuvvet uygulanan noktada, ve uygulanan darbe sonrası şekil dönmeye
başlayarak ve yukarı doğru uçarak devam ediyor (darbe alttan yukarı doğru). 
Simülasyon ortamı boşluk ortamı, uzay gibi yerçekimsiz bir yer, tek kuvvet
ilk başta şekle uygulanan kuvvet, ardından momentum muhafazası ile hareket
devam ediyor.
