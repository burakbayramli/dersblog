...
$i$ parçacýðý çevresindeki $b$ parçacýklarý üzerinden bu kestirme hesabý
yapabileceðiz.

Aradeðerlemenin bize saðladýðý güzel bir özellik onun üzerinden mesela gradyan
alabilmem. Diyelim ki $A$ ölçümü basýnç, yani $p$. O zaman Euler denkleminde
görülen $-\nabla p$ formülünü üstteki entegral üzerinden açabilmem
gerekir. $r$'de olan her $i$ parçacýðý için $p(r_i)$ diyelim,
...
olmaz, fakat fizik kanunlarýna göre etki-tepki ayný olmalýdýr. Simülasyon
