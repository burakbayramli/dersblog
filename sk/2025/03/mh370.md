...
Bu degeri bulmak icin farkli yollar kullanilabilir. Daha once [4]
yazisinda gordugumuz filtreleme teknigi bunlardan biri. Filtremeyi
hatirlarsak bir "tersine cevirme" problemini cozuyordu, robot yerini
saptama problemlerinde cok ise yariyordu. Elde bilinen gurultulu bir
hareket mekanigi vardi, ve gelinen yeri algilayan bilinen ve yine
gurultulu bir algilama (sensor) yontemi vardi. Ardi ardina
hareket/olcum, hareket/olcum seklinde elde edilen verileri kullanarak
problemi tersine cevirip bunu yer bulmak icin kullanabiliyorduk.
