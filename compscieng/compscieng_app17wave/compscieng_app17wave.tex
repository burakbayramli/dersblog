...
Yaklaşıksal çözümü merkezi farklılıklar üzerinden yapacağız,

\includegraphics[width=20em]{compscieng_app17wave_03.png}

$x$ için sola/sağa, $t$ için yukarı/aşağı olacak şekilde iki Taylor açılımı
yapıyoruz, 
...
Sonra her değişkenin iki açılımını birbiri ile topluyoruz. Toplama sonrası tek
sayı terimlerinin iptal olduğunu görürüz, ve kalanlar,
...
farklılık açılımıni yapacağız ve oradan gelen eşitlikleri ana (1)'e sokarak
