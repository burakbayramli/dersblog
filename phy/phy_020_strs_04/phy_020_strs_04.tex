...
Peki $\epsilon_{11}$ nedir? Bu büyüklüğü (1)'de gördük, $epsilon$'un
tek sıfır olmayan öğesi $\epsilon_{11}$ ve orada $\frac{\ud u_1}{\ud X_1}$
değeri var. Bunu üstteki formüle koyalım,
...
biliriz, kırise uygulanan yük $p$'yi biliriz, tüm bunları kullanarak yer değişim
$u_1$'i üstteki formülle bulabiliriz. Tek bilinmeyen $u_1$ cunku.
