...
(yağdı,yağmadı) kullanamayız. Bu durumda matris 4x2 boyutunda olurdu, bu bir
...
yağdı-yağmadı (2 etiketi) konumundan yağdı-yağdı konumuna (3 etiketi) geçişi
yapacağız. Öyle ya, yağdı, yağmadı geçişi sonrası artık yeni bir gündeyiz, artık
iki gün bir gün öncesi oldu, bugün de 'yağdı' durumu var, hedef yağdı-yağdı.
