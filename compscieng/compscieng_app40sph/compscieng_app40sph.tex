...
SPH icin bize ivme gerekli. Kütle ve kuvvetten ivme, oradan sayýsal entegrasyon
ile simülasyon elde edilebilir, katý-gövde simülasyonunu kodlarken [6]'da bu
anlatýlmýþtý. O zaman eldeki $i$'inci parçacýk için toplam kuvvet $F_i$
hesaplarsak
...
ile ivmeyi buluruz, ve oradan devam ederiz. Simülasyon ortamýnda bize gereken
$\nabla p(r_i)$ ve $\nabla^2 u(r_i)$ hesaplarýný yaklaþýk yapabilmemizi
saðlayacak bir yaklaþým kullanmak.
