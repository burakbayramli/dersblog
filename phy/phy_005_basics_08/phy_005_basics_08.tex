...
-heat flux-) bu bahsedilen sıcaklık gradyani ile direk orantılıdır. Formul
olarak
...
alan, ki bu alan ısı akisina dik olan alandır, $\frac{\ud T}{\ud x}$ sıcaklık
gradyanidir, birimi $C / m$, tek boyutta $T-x$ diyagramındaki sıcaklık eğrisinin
eğimi olarak görülebilir (eğim tabii ki yukarı doğru giden bir eğride yükselişin
yönünü gösterir, bir gradyandır).
