...
Genelde kullanım kalıbı ZYX ya da ZXY üzerinden yapılır.

Her eksen etrafındaki dönüş tek bir dönüş matrisi ile gösterilebilir, mesela
Z etrafındaki $\phi$ kadar bir dönüş $D$ matrisinde,
