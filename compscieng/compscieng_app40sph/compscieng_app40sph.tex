...
[2] yazarýnýn belirttiði gibi SPH'in stabilitesi, doðruluðu ve hesap hýzý
pürüzleþtirme çekirdeðinin doðru seçilmiþ olmasýna baðlý. Çekirdek
fonksiyonlarýný hangisinin, hangi durumlarda iyi olacaðý aktif bir araþtýrma
alanýdýr. Yaygýn kullanýlan bir çekirdek poly6 ismiyle bilinen 6. derece polinom
çekirdeðidir. Bu fonksiyon,
...
h = 1
W = (315./(64*np.pi*h**9)) * (h**2 - np.abs(r)**2)**3
plt.plot(r,W)
plt.ylim(0,1.8)
