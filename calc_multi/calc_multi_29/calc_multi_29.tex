...
Peki Uzaklasim Teorisinin fiziksel anlami nedir?

Fiziksel olarak $\bdiv(\vec{F})$ kaynak uretilis orani olarak gorulebilir,
ya da birim hacimde uretilen akis.

Ornek olarak sikistirilamayan bir siviyi dusunelim, mesela su. Suyun sabitlenmis
bir kutlesi her zaman ayni hacmi kaplar. Gazlar sikistirilabilir, onlar
farklidir.  O zaman onumuzde bir sikistirilamayan akis (incopressible flow)
problemi varsa, ve verili bir kutle her zaman ayni hacmi kapliyorsa, ve elimizde
bir $\vec{F}$ hizi var ise (su durumunda vektor alani her noktadaki akis hizi
olarak kabul edilebilir) o zaman Uzaklasim Teorisi sunu soyluyor, belli bir
hacimdeki $\vec{F}$ uzaklasimlarini topla, $\int \int \int_D \bdiv \vec{F} \ud V$, 
bu sayi yuzeyin akisina esit olacaktir. 
