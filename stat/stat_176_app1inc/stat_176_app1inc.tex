...
Eldeki $x_i$ verisi için klasik ortalama hesabı $\bar{x}$ basit, tüm değerleri
topla, ve değer sayısına bol,
...
veri hataları ortaya çıkartabilir. Ortalamayı azar azar hesaplamak mümkün müdür
acaba? Ortalama fazla büyümez, ayrıca paralel işletim açısından azar azar azar
işletim daha ölçeklenebilir bir yaklaşımdır. 
