...
[10]'da gördük, mesela $f(x(t),y(t))$ için $\ud f / \ud t$

$$
\frac{\ud f}{\ud t} =
\frac{\partial f}{\partial x} \cdot \frac{\ud x}{\ud t} +
\frac{\partial f}{\partial y} \cdot \frac{\ud y}{\ud t} 
$$
...
Bu işlemi daha önceki $t$ zamanları için yaparsak, kesikli sarı çizgi ortaya
çıkacaktır. Bu da dalganın sağa doğru akışını gösteriyor bir bakıma.
