...
Bu ifade iki üstteki ile eþit olmalý. Ayrýca her iki tarafta $\Delta V$ var,
çýkartýlabilir, zaten sabit bir hacim,

$$
\frac{\partial \rho}{\partial t}  = -\nabla \cdot (\rho \vec{u} )
$$

Literaturde cogunlukla su formda gosterilir,

$$
\frac{\partial \rho}{\partial t}  + \nabla \cdot (\rho \vec{u} ) = 0
$$

Bu denkleme sureklilik formulu (continuity equation) ya da kutle muhafaza kanunu
