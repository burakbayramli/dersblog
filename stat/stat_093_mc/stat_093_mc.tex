...
açılabilir. Açılımdan  görüleceği üzere bir MZ sonraki adıma geçiş olasılığı
için sadece bir önceki adıma bakar. Bu tür önce/sonra yapısındaki iki boyutlu hal, 
...
Üstteki olasılık hesabına $k$'den geçme birleşik olasılık içine
ekleyip aynı anda tüm $k$'ler üzerinden toplam alırsak hiçbir şey
