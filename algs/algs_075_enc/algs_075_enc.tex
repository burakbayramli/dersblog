...
bağlantılı üçgenler haline çevirmek için kullanışlıdır; bu tür noktalar mekanik
mühendislikte ortaya çıkabilir, diferansiyel denklem çözmek için sayısal
hesaplara gereken izgaralar Delanuay ile yaratılabilir. Noktalar verilir,
üçgen bazlı izgara ortaya çıkartılır, bu izgara hücreleri baz alınarak
hesabın gerisi işletilir.
