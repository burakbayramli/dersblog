...
Ana denklemle baslarsak,

$$
E A \frac{\ud^2 y}{\ud X_1^2} = -p
$$

Artik (residual) hesabi soyle,

$$
R = EA \frac{\ud^2 u}{\ud X_1^2} + p
$$

Bu artığın tanım bölgesi üzerinden ağırlıklı entegralinın sıfır olmasını
istiyoruz,
...
her düğümde tanımlı şekil fonksiyonu (shape function) olacak. O şekillerin
ne seçildiği FEM'in kilit noktası, detayları göreceğiz.

Simdi $R$'yi acip duzenleme yaparsak,
